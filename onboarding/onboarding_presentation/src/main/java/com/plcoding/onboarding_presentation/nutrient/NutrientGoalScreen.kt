    ...
    Box(
        ...
        Column(
            ...
            UnitTextField(
                ...
                onValueChange = {
                    viewModel.onEvent(NutrientGoalTypeEvent.OnCarbRatioEnter(it))
                },
            ...
            UnitTextField(
                ...
                onValueChange = {
                    viewModel.onEvent(NutrientGoalTypeEvent.OnProteinRatioEnter(it))
                },
            ...
            UnitTextField(
                ...
                onValueChange = {
                    viewModel.onEvent(NutrientGoalTypeEvent.OnFatRatioEnter(it))
                },
        ...
        ActionButton(
            ...
            onClick = {
                viewModel.onEvent(NutrientGoalTypeEvent.OnNextClick)
            },
